...
export const StaffOfficerDashboard = () => {
  ...
  const staffApplications = roleApplications?.filter(
    app => app.status === 'document_verification' || app.status === 'staff_review'
  ) || [];
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Review clerk-verified applications and make approval decisions
          </CardDescription>
        </CardHeader>
      </Card>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-2xl font-bold">{staffApplications.filter(app => app.status === 'document_verification').length}</p>
